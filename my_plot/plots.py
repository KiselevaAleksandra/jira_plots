...
def check_cond():
    print(
        '\033[1m' + 'Возможные состояния:' + '\033[0m' + '\n1 - Open\n3 - In Progress\n4 - Reopened\n5 - Resolved\n6 - Closed\n10002 - Patch Available\n')
    print(
        '\033[1m' + 'Введите номер состояния:' + '\033[0m')
    cond = input()
    while 1:
        if (cond == '1'):
            name_cond = 'Open'
            ...
            print(
                '\033[1m' + '\033[91m' + 'Введено неверное значение\n' + '\033[0m' + '\033[1m' + 'Введите номер состояния:' + '\033[0m')
            cond = input()
...
def count_open_close_plot():
    print('\033[1m' + 'Введите количество дней:' + '\033[0m')
    per_str = input()
    per = int(per_str)
...
def print_users():
    ...
    print('\033[1m' + 'Список пользователей:' + '\033[0m')
...
def time_user_plot():
    print_users()
    print('\033[1m' + '\nВведите имя пользователя:' + '\033[0m')
    name = input()
